export default function About() {
  return (
    <section id="about" className="scroll-mt-24 py-24 bg-black text-white px-6">
      <div className="container mx-auto max-w-5xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="aspect-[4/5] bg-neutral-900 rounded-3xl overflow-hidden relative border border-white/10 group">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-neutral-400 font-light leading-relaxed">
              Cantante, vocalista y poetisa afincada en Madrid. Con más de diez años sobre los escenarios, me especializo en fusionar géneros y conectar con el público desde la honestidad y la emoción. Ya sea como vocalista en un cuarteto de soul-funk, en formato acústico íntimo o a través de la palabra escrita en mi primer poemario, mi objetivo es transmitir sensibilidad y energía viva.
            </p>
